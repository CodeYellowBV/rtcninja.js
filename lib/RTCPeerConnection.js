...
var merge = require('merge'),
	...
	// Internal constants.
	C = {
		REGEXP_NORMALIZED_CANDIDATE: /^candidate:/i,
		REGEXP_FIX_CANDIDATE: /(^a=|\r|\n)/gi,
		REGEXP_RELAY_CANDIDATE: / relay /i,
		REGEXP_HOST_CANDIDATE: / typ host/i,
		REGEXP_SDP_CANDIDATES: /^a=candidate:.*\r\n/igm,
		REGEXP_SDP_NON_RELAY_CANDIDATES: /^a=candidate:(.(?!relay ))*\r\n/igm
	},
